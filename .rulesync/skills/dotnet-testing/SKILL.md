...
1. ✅ Let sub-skills provide professional testing guidance
...
1. `dotnet-testing-test-naming-conventions` - Learn naming conventions
1. `dotnet-testing-xunit-project-setup` - Create your first test project
...
1. `dotnet-testing-autofixture-nsubstitute-integration` - (Optional) Integrate AutoFixture with NSubstitute
